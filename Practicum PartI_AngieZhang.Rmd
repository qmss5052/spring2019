...
Removing the following four patients:
...
Issue - does this mean these patients should be removed from Angie's data.frames? Should I have dealt with these differently (e.g. recode them as just not on birth control)? 
...
#Removing the four patients whose bc start dates don't make sense. That should reduce the number of patients who ever used birth control to 242.

remove <- c("a8b24df6-d727-45d2-b269-cf482c17a402", "f88d0d0e-614b-4ab2-aae4-12d103778e0a", "492624fb-49dc-4e16-b6b9-b41619934cd4", "cf9a3357-e145-480e-a2b9-7f9c595b9783")

durationsFV <- durations %>%
  filter(!PATIENT %in% remove)
length(unique(durationsFV$PATIENT[durationsFV$bc.yes==1])) #242, lovely. 
...
Notice there are a lot (223) of women whose first encounter date proceeds their bc.start date. Will this will be an issue if we use first encounter date to set age (as discussed last week)?
